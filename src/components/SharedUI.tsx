        ...
        <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm w-56 focus:outline-none focus:ring-2 focus:ring-[#137fec]/40 focus:border-transparent transition-all"
                />
            </div>
